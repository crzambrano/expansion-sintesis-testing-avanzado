import { CombinatorialOrchestrator } from './combinatorial-orchestrator.js';
...
// 1. Generación
const casosCrudos = CombinatorialOrchestrator.generatePairwiseCases(variablesDeEntrada);
console.log(`[Generador] Casos combinatorios iniciales generados: ${casosCrudos.length}`);

// 2. Priorización por Riesgo
const casosPriorizados = CombinatorialOrchestrator.prioritizeByRisk(casosCrudos);

// 3. Optimización por Aprendizaje Predictivo
const casosConPrediccion = CombinatorialOrchestrator.applyPredictiveLearning(casosPriorizados);
