...
import { ReliabilityPredictor, ModuleData } from './predictive-model.js';

const app = express();
const PORT = 3000;

// Muestra de telemetría consolidada de las Partes 1 y 2
const telemetryData: ModuleData[] = [
...
app.get('/api/metrics', (req, res) => {
  const processed = telemetryData.map(mod => {
    const fallas = ReliabilityPredictor.predictExpectedFailures(mod, 48);
